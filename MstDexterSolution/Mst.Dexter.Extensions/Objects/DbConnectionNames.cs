namespace Mst.Dexter.Extensions.Objects
{
    public static class DbConnectionNames
    {
        ...
        public static readonly string Devart_Oracle = "Devart.Data.Oracle.OracleConnection";
        ...
        public static readonly string NuoDb = "NuoDb.Data.Client.NuoDbConnection";

        public static readonly string SQLDatabaseNet = "SQLDatabase.Net.SQLDatabaseClient.SqlDatabaseConnection";
